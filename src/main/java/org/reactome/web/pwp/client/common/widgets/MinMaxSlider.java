package org.reactome.web.pwp.client.common.widgets;
...
public class MinMaxSlider {
    ...
    public MinMaxSlider(int[] bounds, int[] start) {
        ...
        org.reactome.web.pwp.client.common.interop.MinMaxSlider.create(slider, inputs, bounds, start);
    }
    ...
    public int[] getValues() {
        return org.reactome.web.pwp.client.common.interop.MinMaxSlider.getValues(slider);
    }
}
